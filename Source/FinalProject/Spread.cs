...
{
    public class Spread : GameObject
    {
        public bool isActive = false;
        private TerrainRenderer Terrain;

        public Spread(TerrainRenderer terrain, ContentManager Content, Camera camera, GraphicsDevice graphicsDevice, Light light, float speed) : base()
        {
            Terrain = terrain;
            // add rigidbody
            ...
            //add renderer
            Texture2D texture = Content.Load<Texture2D>("Textures/power2tex");
            ...
            renderer.Material.Diffuse = new Vector3(0.5f, 0.5f, 3f);
